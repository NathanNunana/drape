...
const ContactUs: React.FC = () => {
  ...
  return (
    <div className="bg-white">
      <ToastContainer />
      <div className="text-left mb-5 text-gray-500 bg-gray-100 px-8 lg:px-48 py-5">
        <p className="text-sm">
          <span className="text-red-500">Home</span> / About Us
        </p>
      </div>
      <div className="container mx-auto px-8 lg:px-48 mb-5">
        <h1 className="text-4xl font-bold mb-6 text-center text-red-500">Contact Us</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white p-6 shadow-sm text-center border border-gray-50">
            ...
            <p className="text-gray-700">Mile 7, 1 Dolphin Street, GW-1054-8520, Accra Ghana</p>
          </div>

          <div className="bg-white p-6 shadow-sm text-center border border-gray-50">
            <FaEnvelope className="text-red-500 text-4xl mx-auto mb-4" />
            <h2 className="text-xl font-semibold mb-2">Email Us</h2>
            <p className="text-gray-700">sales@tropicalpartsgh.com</p>
            <p className="text-gray-700">info@tropicalpartsgh.com</p>
          </div>

          <div className="bg-white p-6 shadow-sm text-center border border-gray-50">
            <FaPhone className="text-red-500 text-4xl mx-auto mb-4" />
